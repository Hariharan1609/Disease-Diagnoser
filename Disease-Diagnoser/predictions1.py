...
def prediction(path):
    ...
    trained_model.load_state_dict(torch.load('model/pneumonia/pneumonia full.pth'), strict=False)
    trained_model1.load_state_dict(torch.load('model/pneumonia/pneumonia1.pth'), strict=False)
    trained_model2.load_state_dict(torch.load('model/pneumonia/pneumonia2.pth'), strict=False)
    trained_model3.load_state_dict(torch.load('model/pneumonia/pneumonia3.pth'), strict=False)
    trained_model4.load_state_dict(torch.load('model/pneumonia/pneumonia4.pth'), strict=False)
    trained_model5.load_state_dict(torch.load('model/pneumonia/pneumonia5.pth'), strict=False)

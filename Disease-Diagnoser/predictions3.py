...
def prediction(path):
    ...
    trained_model.load_state_dict(torch.load('model/tuberculosis/tuberculosisfull.pth'), strict=False)
    trained_model1.load_state_dict(torch.load('model/tuberculosis/tuberculosis1.pth'), strict=False)
    trained_model2.load_state_dict(torch.load('model/tuberculosis/tuberculosis2.pth'), strict=False)
    trained_model3.load_state_dict(torch.load('model/tuberculosis/tuberculosis3.pth'), strict=False)
    trained_model4.load_state_dict(torch.load('model/tuberculosis/tuberculosis4.pth'), strict=False)
    trained_model5.load_state_dict(torch.load('model/tuberculosis/tuberculosis5.pth'), strict=False)
